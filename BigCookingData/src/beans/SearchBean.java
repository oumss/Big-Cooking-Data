...
public class SearchBean implements Serializable {
	...
	public void init() {
		...
		cat.setSelectItems(new SelectItem[] {new SelectItem("", "Select One"), new SelectItem("Entr�e", "Entr�e"), new SelectItem("Plat", "Plat"),
	...
	public String selectedCategoriesFunc() {
		if(this.selectedCategories.equals("")) {
			...
			return "(Cat�gorie: ''" + this.selectedCategories +"'')";
		}
