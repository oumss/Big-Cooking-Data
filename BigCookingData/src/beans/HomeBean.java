...
public class HomeBean implements Serializable {
	...
	public void init() {
        ...
        legumes.setSelectItems(new SelectItem[] {
            new SelectItem("Concombre", "Concombre"),
            new SelectItem("Tomate", "Tomate"),
            new SelectItem("Aubergine", "Aubergine"),
            new SelectItem("Pomme de terre", "Pomme de terre"),
            new SelectItem("Tomate", "Tomate"),
            new SelectItem("Oignon", "Oignon")
        });
         
        SelectItemGroup fruits = new SelectItemGroup("Fruits");
        fruits.setSelectItems(new SelectItem[]{
            new SelectItem("Cerise", "Cerise"),
            new SelectItem("Framboise", "Framboise"),
            new SelectItem("Fraise", "Fraise"),
            new SelectItem("Mangue", "Mangue"),
            new SelectItem("Ananas", "Ananas"),
            new SelectItem("Kiwi", "Kiwi")
        });
