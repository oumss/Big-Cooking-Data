...
public class ConverterTxt {
	...
	public static void main(String[] args) throws IOException {
		File fileA = new File(new File("src//ingredients//csv.txt").getAbsolutePath());
		FileWriter fileB = new FileWriter(new File("src//ingredients//insert.txt").getAbsolutePath());
