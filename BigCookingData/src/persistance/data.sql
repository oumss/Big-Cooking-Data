...
INSERT INTO `recipe`(`id_recipe`, `id_ingredient_recipe`, `name`, `picture`, `price`, `time`,`steps`) VALUES (1,1,"Pomme de terre chelou",null,1,"3h20","1.bla bla blo");
...
INSERT INTO `recipe`(`id_recipe`, `id_ingredient_recipe`, `name`, `picture`, `price`, `time`,`steps`) VALUES (2,2,"Tarte aux choux",null,2,"30min","1.bla 2.bla 3.blo");
